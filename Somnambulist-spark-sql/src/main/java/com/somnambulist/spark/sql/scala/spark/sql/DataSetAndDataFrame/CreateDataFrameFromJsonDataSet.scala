...
/**
  * 由json格式的RDD转换成DataFrame,在旧的版本中 com.jyong.scala.com.jyong.scala.spark.read.com.jyong.scala.json(jsonRDD<String>) ,这中方式2.3+被丢弃
...
object CreateDataFrameFromJsonDataSet {
  def main(args: Array[String]): Unit = {
    ...
    /**
      * 1.6版本方式
      */
//    val jsonRDD: RDD[String] = com.jyong.scala.com.jyong.scala.spark.sparkContext.parallelize(jsonList)
//    val df1: DataFrame = com.jyong.scala.com.jyong.scala.spark.read.com.jyong.scala.json(jsonRDD)
//    df1.show(100)
...
//    val frame: DataFrame = com.jyong.scala.com.jyong.scala.spark.sql("select * from person")
//    frame.show()
