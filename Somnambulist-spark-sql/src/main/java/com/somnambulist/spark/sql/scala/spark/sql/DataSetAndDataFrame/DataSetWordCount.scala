...
//      "hello com.jyong.scala.com.jyong.scala.spark","hello sparksql","hello sparkStreaming"
//    )
...
//    linesDs.show()
    ...
    /**
      * 使用DataSet api 处理
      * 这里需要导入隐式转换
      *   com.jyong.scala.com.jyong.scala.spark.implicits._
      * 使用agg聚合中的聚合函数，这里也要导入spark sql中的函数
      *   import org.apache.com.jyong.scala.com.jyong.scala.spark.sql.functions._
      */
