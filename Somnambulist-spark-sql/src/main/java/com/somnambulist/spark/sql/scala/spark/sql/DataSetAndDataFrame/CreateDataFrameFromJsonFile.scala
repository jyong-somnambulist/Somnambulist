...
object CreateDataFrameFromJsonFile {
  def main(args: Array[String]): Unit = {
    ...
    /**
      ...
      * import  com.jyong.scala.com.jyong.scala.spark.implicits._
      */

//    val df: DataFrame = com.jyong.scala.com.jyong.scala.spark.read.com.jyong.scala.json("./data/com.jyong.scala.json")
//    val df: DataFrame= com.jyong.scala.com.jyong.scala.spark.read.format("com.jyong.scala.json").load("./data/com.jyong.scala.json")
...
//    val frame: DataFrame = com.jyong.scala.com.jyong.scala.spark.sql("select  * from students")
//    frame.show()
//    import com.jyong.scala.com.jyong.scala.spark._
...
//
//    //创建一个新的session
//    com.jyong.scala.com.jyong.scala.spark.newSession().sql("SELECT * FROM global_temp.students").show()
//    com.jyong.scala.com.jyong.scala.spark.newSession().sql("SELECT * FROM students").show()
