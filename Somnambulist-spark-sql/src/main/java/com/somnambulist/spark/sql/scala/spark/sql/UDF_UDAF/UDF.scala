package com.somnambulist.spark.sql.scala.spark.sql.UDF_UDAF
...
//    com.jyong.scala.com.jyong.scala.spark.udf.register("STRLEN",(name:String,i:Int)=>{
//      name.length+i
//    })
//    com.jyong.scala.com.jyong.scala.spark.sql("select name ,STRLEN(name,10) as length from students order by length desc").show(100)
  }
}
