package com.somnambulist.spark.sql.scala.spark.sql.windows
...
object OverFunctioOnMySQL {
  def main(args: Array[String]): Unit = {
    ...
    val person: DataFrame = spark.read.jdbc("jdbc:mysql://192.168.179.101:3306/com.jyong.scala.com.jyong.scala.spark",s"($sql) T",properties)
    person.show()
  }
}
