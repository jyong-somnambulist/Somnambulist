package com.somnambulist.spark.streaming.scala.streaming.streamingOnKafka
...
/**
  ...
  *     可以通过参数 com.jyong.scala.com.jyong.scala.spark.streaming.kafka.consumer.cache.maxCapacity 来增大，也可以通过spark.streaming.kafka.consumer.cache.enabled 设置成false 关闭缓存机制。
...
//    ssc.sparkContext.setLogLevel("ERROR")
    ...
    val topics = Array[String]("topic032001")
