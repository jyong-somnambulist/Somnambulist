package com.somnambulist.spark.streaming.scala.streaming
...
object SaveAsTextFile {
  def main(args: Array[String]): Unit = {
    ...
    //保存的多级目录就直接写在前缀中
    result.saveAsTextFiles("./data/streamingSavePath/com.jyong.scala.com.jyong.scala.spark/prefix","suffix")
    ssc.start()
